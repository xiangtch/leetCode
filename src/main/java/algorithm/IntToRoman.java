...
public class IntToRoman {
    ...
    * */
    ...
    public static void main(String[] args) {
        System.out.println(findIntToRoman(3));
        System.out.println(findIntToRoman(4));
        System.out.println(findIntToRoman(9));
        System.out.println(findIntToRoman(58));
        System.out.println(findIntToRoman(1994));
    }
     ...
     * @return 罗马字符串
     */
    private static String findIntToRoman(int num) {
        // 限制数字大小
        if (num > 3999 || num < 1){
